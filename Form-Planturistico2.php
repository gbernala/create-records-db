...
$nom_plan = $_REQUEST["nom_plan"];
$dest_plan = $_REQUEST["dest_plan"];
...
$sql = "INSERT INTO planTuristico (cod_plan,nom_plan,dest_plan,valor_plan,nit_age) values('$cod_plan','$nom_plan','$dest_plan','$valor_plan','$nit_age');";
...
if ($result) {
  echo "agencia creada satisfactoriamente";
}
